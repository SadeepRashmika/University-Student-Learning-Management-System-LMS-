...
$stmt = $conn->prepare("SELECT COUNT(*) as total_courses FROM enrollments WHERE student_id = ? AND status = 'enrolled'");
$stmt->bind_param("i", $user_id);
$stmt->execute();
$result = $stmt->get_result();
...
$stmt->execute();
$result = $stmt->get_result();
$completed_courses = $result->fetch_assoc()['completed'];
$stmt->close();
    ...
    <div class="main-content">
        ...
        <div class="profile-layout">
            <div class="profile-card">
                ...
                <div class="profile-id"><?php echo htmlspecialchars($student['student_id']); ?></div>
                ...
                <div class="photo-actions">
                    ...
                    <form method="POST" id="removePhotoForm" style="flex: 1;">
                        <button type="button" class="btn-photo btn-remove" onclick="confirmRemovePhoto()" <?php echo (!$student['profile_image']) ? 'disabled' : ''; ?>>
                            🗑️ Remove
                        </button>
                    </form>
                </div>
                ...
                <div class="profile-stats">
                    ...
                    <div class="stat-item">
                        <span class="stat-value"><?php echo number_format($avg_gpa, 2); ?></span>
                ...
                <div class="form-section">
                    ...
                    <form method="POST" action="">
                        <div class="form-group">
                            ...
                            <input type="text" id="username" class="form-control" value="<?php echo htmlspecialchars($student['username']); ?>" disabled>
                        </div>
                        
                        <div class="form-group">
                            <label for="student_id">Student ID</label>
                            <input type="text" id="student_id" class="form-control" value="<?php echo htmlspecialchars($student['student_id']); ?>" disabled>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="phone" name="phone" class="form-control" value="<?php echo htmlspecialchars($student['phone'] ?? ''); ?>" placeholder="Enter your phone number">
                        </div>
